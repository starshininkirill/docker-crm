<template>
    <form @submit.prevent="submitForm"
        ...
        <div class="flex flex-col gap-1">
            ...
            <VueSelect v-model="form.is_technical" :reduce="texnical => texnical.id" label="name" :options="texnical">
            </VueSelect>
        </div>
        ...
        <div class="flex flex-col gap-1">
            ...
            <VueSelect v-model="form.responsible_id" :reduce="user => user.id" label="full_name" :options="users">
            </VueSelect>
        </div>
        ...
        <div class="flex flex-col gap-1">
            ...
            <VueSelect v-model="form.organization_id" :reduce="organization => organization.id" label="short_name"
                :options="organizations">
            </VueSelect>
        </div>

        <FormInput v-model="form.confirmed_at" type="datetime-local" name="confirmed_at" label="Когда потдверждён" />
